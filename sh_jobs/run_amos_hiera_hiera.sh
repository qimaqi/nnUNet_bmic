...
#SBATCH --output=sbatch_log/amos_hiera_hiera_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 219 3d_fullres_video_mae_vit_decoder 0 -p VideoMAELPlans -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_pretrain_vit_large_k700.pth --c

nnUNetv2_train 219 3d_fullres_hiera_hiera_decoder 1 -p HieraPlans -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_hiera_large_16x224.pth
