...
#SBATCH --output=sbatch_log/running_amos_nmasked_fold2_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 219 3d_fullres_video_mae_mask_decoder 0 -p VideoMAELPlans -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_pretrain_vit_large_k700.pth

nnUNetv2_train 219 3d_fullres_video_mae_mask_decoder 2 -p VideoMAELPlans -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_pretrain_vit_large_k700.pth
# 0.8782433373184362
