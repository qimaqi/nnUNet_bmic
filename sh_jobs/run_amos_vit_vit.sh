...
#SBATCH --output=sbatch_log/running_amos_videomae_vit_amos_k700_fold2_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 219 3d_fullres_video_mae_vit_decoder 3 -p VideoMAELPlans -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_pretrain_vit_large_k700.pth 
