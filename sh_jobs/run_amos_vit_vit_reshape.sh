...
#SBATCH --output=sbatch_log/running_amos_videomae_vit_fold0_amos_shape_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 219 3d_fullres_video_mae_vit_decoder_reshape 0 -p VideoMAELPlans --c
