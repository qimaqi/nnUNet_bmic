...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_inception_conv_elu_inception0%j.out
#SBATCH --nodes=1
#SBATCH --time=48:00:00
#SBATCH --gres=gpu:1

#SBATCH --nodelist=octopus03
# bmicgpu07,bmicgpu08,bmicgpu09,octopus01,octopus02,octopus03,octopus04
...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_learningrate1e-3_inception0_mixed 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_inception0 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer --c
 
# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_inception0 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
