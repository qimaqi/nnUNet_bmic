...
cd ..
nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1_stack2 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1_stack2 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1_stack2 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1_stack2 3 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1_stack2 4 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
