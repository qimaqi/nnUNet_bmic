...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_inception_conv_softmax_debug_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_debug 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack1_debug 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack3_debug 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_fast_conv_debug 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer 

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_elu 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
