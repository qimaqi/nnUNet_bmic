...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_pos1_stack2_%j.out
#SBATCH --nodes=1
...
cd ..
nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_10 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_10 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_10 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_10 3 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_10 4 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
