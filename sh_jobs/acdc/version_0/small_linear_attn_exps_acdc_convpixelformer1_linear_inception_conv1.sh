...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack0_debug 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack0_debug 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack0_debug 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_debug 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
