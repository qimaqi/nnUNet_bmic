...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack1_global 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer --c
