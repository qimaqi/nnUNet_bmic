...
nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1 3 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

nnUNetv2_train 27 3d_fullres_convformer_2layer_global_pos_1 4 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
