...
cd ..
nnUNetv2_train 27 3d_fullres_convformer_2layer_baseline 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_plain_unet_2layer 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_plain_unet_2layer 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_plain_unet_2layer 3 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_plain_unet_2layer 4 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
