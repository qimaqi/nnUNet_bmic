...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_global_hedge_learningrate1e-3_nopos_mixed 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer --c
