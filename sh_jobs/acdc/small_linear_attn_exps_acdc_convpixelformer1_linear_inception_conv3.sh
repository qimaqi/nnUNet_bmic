...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_inception_conv_elu_inception3_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_inception3 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
