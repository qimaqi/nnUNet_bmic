...
nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_learningrate1e-3_inception4_mixed 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer


# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_inception4 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
