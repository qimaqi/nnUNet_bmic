...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_inception_conv_softmax_linear_attn_global_fold0_pos3_%j.out
#SBATCH --nodes=1
#SBATCH --time=48:00:00
#SBATCH --gres=gpu:1

#SBATCH --nodelist=bmicgpu07
# ,bmicgpu08,bmicgpu09,octopus01,octopus02,octopus03,octopus04
...
# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_global_learningrate1e-3_nopos_mixed 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer --c


nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_global_learningrate1e-3_pos3_mixed 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
