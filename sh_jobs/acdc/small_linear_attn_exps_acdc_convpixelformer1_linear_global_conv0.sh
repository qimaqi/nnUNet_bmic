...
#SBATCH --output=sbatch_log/convformer0_2layer_acdc_inception_conv_softmax_linear_attn_global_fold0_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_softmax_stack2_global 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_global_learningrate1e-4 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer





nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_global 1 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer --c

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_global 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 27 3d_fullres_convformer_2layer_linear_inception_pos_2_conv_elu_stack2_global 2 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer
