...
#SBATCH --output=sbatch_log/amos_nnunet_resm_fold_1%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 219 3d_fullres_linear 1 -p nnUNetResEncLinAttnUNetMPlans 
...
# nnUNetv2_train 219 3d_fullres_video_mae 1 -p VideoMAELPlans 


# nnUNetv2_train 219 3d_fullres 0 -p nnUNetResEncUNetMPlans
# 0.892048116476406
# nnUNetv2_train 219 3d_fullres 1 -p nnUNetResEncUNetMPlans
# # 0.8899693228506063
# nnUNetv2_train 219 3d_fullres 2 -p nnUNetResEncUNetMPlans
