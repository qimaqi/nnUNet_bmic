...
# nnUNetv2_extract_fingerprint -d 202 -np 16 
# # nnUNetv2_plan_experiment -d 218 -pl nnUNetPlannerResEncM --clean   nnUNetResEncUNetMPlans.json
# nnUNetv2_plan_experiment -d 202 -pl nnUNetPlannerResEncM  nnUNetResEncUNetMPlans.json
...
nnUNetv2_preprocess -d 202 -c 3d_fullres -plans_name nnUNetResEncUNetMPlans 
