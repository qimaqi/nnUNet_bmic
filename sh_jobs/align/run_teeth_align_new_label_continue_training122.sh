#!/bin/bash
#SBATCH --job-name=align_teeth_continue_training_122_100e
...
# nnUNetv2_plan_experiment -d 122 -pl nnUNetPlannerResEncL  nnUNetResEncUNetLPlans.json
# nnUNetv2_preprocess -d 122 -c 3d_fullres -plans_name nnUNetResEncUNetLPlans -np 4

nnUNetv2_train 122 3d_fullres_pad_seg_layers 0 -p nnUNetResEncUNetLPlans  -tr nnUNetTrainerNoMirroring_finetune100 -pretrained_weights /usr/bmicnas01/data-biwi-01/ct_video_mae_bmicscratch/data/nnUNet_results/Dataset888_teeth/nnUNetTrainerNoMirroring__nnUNetResEncUNetLPlans__3d_fullres/fold_0/checkpoint_best.pth
