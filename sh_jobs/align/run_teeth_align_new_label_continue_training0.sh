#!/bin/bash
#SBATCH --job-name=align_teeth_continue_training_120_100e_reinit
...
nnUNetv2_train 120 3d_fullres_pad_seg_layers 0 -p nnUNetResEncUNetLPlans  -tr nnUNetTrainerNoMirroring_finetune100 -pretrained_weights /usr/bmicnas01/data-biwi-01/ct_video_mae_bmicscratch/data/nnUNet_results/Dataset888_teeth/nnUNetTrainerNoMirroring__nnUNetResEncUNetLPlans__3d_fullres/fold_0/checkpoint_final.pth


# nnUNetv2_train 120 3d_fullres 0 -p nnUNetResEncUNetLPlans  -tr nnUNetTrainerNoMirroring_finetune100 -pretrained_weights /usr/bmicnas01/data-biwi-01/ct_video_mae_bmicscratch/data/nnUNet_results/Dataset888_teeth/nnUNetTrainerNoMirroring__nnUNetResEncUNetLPlans__3d_fullres/fold_0/checkpoint_best.pth
