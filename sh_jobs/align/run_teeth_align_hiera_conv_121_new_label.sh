#!/bin/bash
#!/bin/bash
#SBATCH --job-name=crop_seg_hiera_conv_121_new_label_from_122
#SBATCH --output=sbatch_log/crop_seg_hiera_conv_121_new_label_from_122_s%j.out
#SBATCH --nodes=1
