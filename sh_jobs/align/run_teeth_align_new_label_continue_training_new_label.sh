#!/bin/bash
#SBATCH --job-name=align_teeth_continue_training_121_100e
#SBATCH --output=sbatch_log/align_teeth_continue_training_121_100e_%j.out
#SBATCH --nodes=1
