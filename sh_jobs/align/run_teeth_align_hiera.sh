...
#SBATCH --output=sbatch_log/align_teeth_hiera_pre_%j.out
#SBATCH --nodes=1
...
# start
# nnUNetv2_train 888 3d_fullres_hiera_hiera_decoder_epoch1500_iter350_nomirror all -p HieraPlans -tr nnUNetTrainer_VideoHiera -pretrained_weights=/scratch_net/schusch/qimaqi/cbct_proj/CBCT/Video_MAE_Seg/checkpoints/mae_hiera_large_16x224.pth

# resume
nnUNetv2_train 888 3d_fullres_hiera_hiera_decoder_epoch1500_iter350_nomirror all -p HieraPlans -tr nnUNetTrainer_VideoHiera --c