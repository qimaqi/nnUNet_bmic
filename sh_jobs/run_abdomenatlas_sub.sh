...
#SBATCH --output=sbatch_log/abdomaltas_vit_conv_fold1_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 224 3d_fullres_video_mae_conv_decoder_e1500 1 -p VideoMAEPlans -pretrained_weights=/usr/bmicnas01/data-biwi-01/ct_video_mae_bmicscratch/data/results_video_mae/pretrained_weights/videomae_abdomatlas_k700/checkpoint-last.pth 
