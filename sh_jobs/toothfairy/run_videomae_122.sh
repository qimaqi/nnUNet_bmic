#!/bin/bash
#SBATCH --job-name=n122_3d_fullres
#SBATCH --output=sbatch_log/n122_3d_videomae_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 122 3d_fullres_video_mae_vit_decoder_epoch1000_iter350_nomirror_video_pre 0 -p VideoMAELPlans -tr nnUNetTrainer_VideoMAE_NoMirroring -pretrained_weights=/usr/bmicnas02/data-biwi-01/lung_detection/nnDetection_Custom/checkpoints/checkpoint-last_16_224_224.pth
