...
#SBATCH --output=sbatch_log/running_linear_attn_exps_amos_fold_pos20_sigmoid_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 219 3d_fullres_linear_posenc20_sigmoid 1 -p nnUNetResEncLinAttnUNetMPlans 

# nnUNetv2_train 219 3d_fullres_linear_posenc20_compress 0 -p nnUNetResEncLinAttnUNetMPlans --c
