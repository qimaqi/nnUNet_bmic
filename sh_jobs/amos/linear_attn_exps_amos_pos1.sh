...
#SBATCH --output=sbatch_log/running_linear_attn_exps_amos_fold_pos1s_4layer_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 219 3d_fullres_linear_posenc1_4layer 0 -p nnUNetResEncLinAttnUNetMPlans --c

nnUNetv2_train 219 3d_fullres_linear_posenc1_4layer 1 -p nnUNetResEncLinAttnUNetMPlans --c -tr nnUNetTrainer_Inception


# nnUNetv2_train 219 3d_fullres_linear_posenc1 0 -p nnUNetResEncLinAttnUNetMPlans --c

# nnUNetv2_train 219 3d_fullres_linear_posenc1 1 -p nnUNetResEncLinAttnUNetMPlans --c
