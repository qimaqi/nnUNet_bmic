...
#SBATCH --output=sbatch_log/running_linear_attn_exps_amos_fold_pos10_%j.out
#SBATCH --nodes=1
...
# nnUNetv2_train 219 3d_fullres_linear_posenc10 0 -p nnUNetResEncLinAttnUNetMPlans --c

nnUNetv2_train 219 3d_fullres_linear_posenc10 1 -p nnUNetResEncLinAttnUNetMPlans --c
