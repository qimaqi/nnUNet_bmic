...
#SBATCH --output=sbatch_log/running_linear_attn_exps_amos_fold0_pos2_sigmoid_4layer_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 219 3d_fullres_linear_posenc2_sigmoid_4layer 0 -p nnUNetResEncLinAttnUNetMPlans
