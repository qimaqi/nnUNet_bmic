...
cd ..
nnUNetv2_train 219 3d_fullres_plain_unet_3layer 0 -p ConvPixelFormerSPlans -tr nnUNetTrainer_ConvPixelPixelFormer

# nnUNetv2_train 219 3d_fullres_4layer 1 -p nnUNetResEncUNetMPlans --c

# nnUNetv2_train 219 3d_fullres_4layer 2 -p nnUNetResEncUNetMPlans --c


# nnUNetv2_train 219 3d_fullres_4layer 3 -p nnUNetResEncUNetMPlans --c

# nnUNetv2_train 219 3d_fullres_4layer 4 -p nnUNetResEncUNetMPlans


# nnUNetv2_train 219 3d_fullres_linear_posenc0_small 0 -p nnUNetTrainer_ConvPixelInceptionFormerSmallPlans -tr nnUNetTrainer_ConvPixelInceptionFormer