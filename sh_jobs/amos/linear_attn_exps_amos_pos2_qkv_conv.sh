...
#SBATCH --output=sbatch_log/running_linear_attn_exps_amos_fold0_pos2_qkvconv_%j.out
#SBATCH --nodes=1
...
nnUNetv2_train 219 3d_fullres_linear_posenc2_qkvf_conv 0 -p nnUNetResEncLinAttnUNetMPlans
