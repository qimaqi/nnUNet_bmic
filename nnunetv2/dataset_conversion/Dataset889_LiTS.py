...
if __name__ == '__main__':
    ...
    parser.add_argument('input_folder', type=str,
                        help="The downloaded and extracted LiTS dataset (must have .nii files)")
    parser.add_argument('-d', required=False, type=int, default=220, help='nnU-Net Dataset ID, default: 889')
    args = parser.parse_args()
    amos_base = args.input_folder
    convert_LiTS(amos_base, args.d)
