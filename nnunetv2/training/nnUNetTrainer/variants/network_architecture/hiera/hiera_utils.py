...
class Unroll(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.size = [i // s for i, s in zip(input_size, patch_stride)] # patch stride decide the token number at begining
        # unroll schedule decide how the sptial token change
