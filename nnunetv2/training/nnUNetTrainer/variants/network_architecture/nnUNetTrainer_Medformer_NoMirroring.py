...
from nnunetv2.utilities.get_network_from_plans import get_network_medformer_from_plans
from nnunetv2.utilities.plans_handling.plans_handler import PlansManager
from nnunetv2.paths import nnUNet_preprocessed, nnUNet_results
from batchgenerators.utilities.file_and_folder_operations import join, load_json, isfile, save_json, maybe_mkdir_p
from nnunetv2.training.logging.nnunet_logger import nnUNetLogger

class nnUNetTrainer_Medformer_NoMirroring(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        assert 'medformer' in self.configuration_manager.network_arch_class_name
        print("=====================================================================")
        ...
        if '_epoch' in configuration or '_iter' in configuration:
            ...
            print("====== Using adjusted num_epochs and num_iterations_per_epoch in Medformer =========")
            for p in parts:
                if 'epoch' in p:
        ...
        if len(self.configuration_manager.network_arch_init_kwargs['deep_supervision_scales']) == 0:
            ...
            print("====== enable_deep_supervision in Medformer =========", self.enable_deep_supervision)
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        assert 'medformer' in architecture_class_name
        return get_network_medformer_from_plans(
