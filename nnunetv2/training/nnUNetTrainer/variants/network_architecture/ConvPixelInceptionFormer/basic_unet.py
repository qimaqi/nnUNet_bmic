...
class BasicUnet_Decoder2Layer(nn.Module):
    def __init__(
        ...
        self.upcat_1 = UpCat(spatial_dims, fea[1], fea[0], fea[-1], act, norm, bias, dropout, upsample, halves=False)
...
class BasicUNet2Layer(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = BasicUnet_Encoder2Layer(
            spatial_dims, input_channels, num_classes, features, act, norm, bias, dropout, upsample
        )
        self.decoder = BasicUnet_Decoder2Layer(
            spatial_dims, input_channels, num_classes, features, act, norm, bias, dropout, upsample, deep_supervision, deep_supervision_scales
        )
