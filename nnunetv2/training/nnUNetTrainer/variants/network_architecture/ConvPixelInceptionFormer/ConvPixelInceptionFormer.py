...
class ConvPixelInceptionFormer(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
                 features_per_stage: Union[int, List[int], Tuple[int, ...]],
        ...
        self.encoder = ResidualEncoder(input_channels, n_stages, features_per_stage, conv_op, kernel_sizes, strides,
                                       ...
                                       return_skips=True, disable_default_stem=False, stem_channels=stem_channels, patch_size=patch_size, pos_enc=pos_enc,
                                       qk_dim_compresion=qk_dim_compresion, qk_nonlin=qk_nonlin, qkv_func=qkv_func, map_func=map_func)
        self.decoder = UNetDecoder(self.encoder, num_classes, n_conv_per_stage_decoder, deep_supervision)
...
if __name__ == '__main__':
    ...
    net = ResidualEncoderLinrAttnUNet(input_channels=1, n_stages=6, features_per_stage=(32, 64, 128, 256, 320, 320),
